...
// Obtener ruta del módulo de los parámetros de línea de comandos.
var modulePath = process.argv[2];

// Importar módulos requeridos: assert para los tests y giveMe42 es la función a probar.
var assert = require('assert');
var isCoolNumber = require(modulePath);

// Obtener el resultado
var es42 = isCoolNumber(42);

// Comprobar que el resultado es el esperado.
assert.ok(es42, "error");