...
test('feedcat', function (t) {
    'use strict';
    t.plan(2);
    t.equal('yum', feedcat('brocoli'), 'It returns yum when you pass any food but chocolate.');
    t.throws(feedcat.bind(null, 'chocolate'), 'It throws error when you pass chocolate.');
});